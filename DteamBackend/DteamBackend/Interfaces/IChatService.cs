...
namespace DteamBackend.Interfaces
{
    public interface IChatService
    {
        ...
        Task<bool> DeleteMessageAsync(Guid currentUserId, Guid messageId, CancellationToken cancellationToken = default);
        ...
        Task<(Stream Stream, string ContentType, string FileName)?> GetUploadPreviewAsync(Guid currentUserId, Guid uploadId, CancellationToken cancellationToken = default);
